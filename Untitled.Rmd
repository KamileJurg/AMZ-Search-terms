...
delcategories <- c("Amazon_Prints","Mobile_Apps", "Apparel", "Video Games", "Software", "Grocery", "Audible", "Books","Digital_Video_Download", "Gift Card", "Furniture", "Shoes")
...
", "CeraVe", "Cetaphil", "SanDisk", "Milwaukee")
...
```{r cars}
terms <- c("Search Term")
delterms <- c("Lenovo", "HP", "beats", "JBL", "Samsung", "BRITA
", "CeraVe", "Cetaphil", "SanDisk", "Milwaukee", "Pokemon", "iphone", "1", "alexa", "kindle", "led lights", "squishmallow", "water bottles", "valentines day gifts", "mouse pad", "valentines cards", "scrub daddy", "valentines day decor","hello kitty", "ipad", "fitbit", "sol de janeiro", "desk organizers and accessories", "airpod pro case")
